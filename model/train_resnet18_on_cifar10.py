...
train_dataset = torchvision.datasets.CIFAR10('/kaggle/input/dataset1/dataset1', train=True, transform=transform_train)
test_dataset = torchvision.datasets.CIFAR10('/kaggle/input/dataset1/dataset1', train=False, transform=transform_test)
